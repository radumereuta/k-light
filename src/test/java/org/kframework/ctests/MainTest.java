...
public class MainTest {
    ...
    @Test
    public void testAll() {
        runTests("src/test/k/unparametric_examples");
    }

    @Test
    public void testSmall() {
        runTests("src/test/k/disambiguation/disamb_imp/small/examples");
    }

    @Test
    public void testImp() {
        runTests("src/test/k/disambiguation/disamb_imp/imp/examples");
    }


    private void runTests(String startPath) {
    ...
    private String process(File f) {
        ...
        try {
            RunProcess.ProcessOutput po = RunProcess.execute(new HashMap<>(), f.getParentFile(), "kore-parser", "--no-print-definition", f.getAbsolutePath() + termination);
