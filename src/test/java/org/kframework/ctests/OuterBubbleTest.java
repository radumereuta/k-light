...
public class OuterBubbleTest {

    private String startPath = "src/test/k/outer/tests";
    private String kastPath = "src/test/k/outer";
    private File definitionFile = new File(kastPath + "/outer-k.k");
    private String mainModule = "OUTER-K";
    private String mainSyntaxModule = "OUTER-K";
    ...
    private String process(File f) {
        ...
        String str = TreeNodesToKORE.print(rez._1.right().get());
