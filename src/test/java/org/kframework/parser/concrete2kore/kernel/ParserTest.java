...
public class ParserTest {
    ...
    public void testListAmbiguity() throws Exception {
        ...
        Production p22 = prod(EXP_SORT, NonTerminal(Sort("Int")));
    ...
    public static Production tokenProd(Sort sort, ProductionItem... pi) {
        return Production(sort, immutable(Arrays.asList(pi)), Att().add("token"));
    }
    ...
    public static Production constant(String x) {
        return tokenProd(Sort("K"), Terminal(x));
    }

    public static Production label(String x) {
        return Production(x, Sort("K"), Seq(NonTerminal(Sort("K"))));
    }
