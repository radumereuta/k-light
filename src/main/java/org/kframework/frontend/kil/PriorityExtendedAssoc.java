...
public class PriorityExtendedAssoc extends ModuleItem implements Interfaces.MutableList<KLabelConstant, Enum<?>>{
    ...
    public List<KLabelConstant> getTags() {
        return tags;
    }

    public void setTags(List<KLabelConstant> tags) {
        this.tags = tags;
    }

    public PriorityExtendedAssoc(String assoc, List<KLabelConstant> tags) {
        super();
        this.tags = tags;
        this.assoc = assoc;
    }
