...
public class Cast extends Term implements Interfaces.MutableParent<Term, Enum<?>> {
    ...
    public Cast(Term t, CastType type, org.kframework.frontend.kil.loader.Context context) {
        this(null, null, t, type, context);
    }

    public Cast(Location location, Source source, Term t, CastType type, org.kframework.frontend.kil.loader.Context context) {
