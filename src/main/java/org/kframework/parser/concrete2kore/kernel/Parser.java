...
/**
 * This is the main code for running the org.kframework.parser.
 *
 * ----------------
 * Overview
 * ----------------
 *
 * The org.kframework.parser operates by maintaining tables of {@link NonTerminalCall},
 ...
 *
 * The main loop of the org.kframework.parser then processes elements in this queue until
 * it is empty.
 *
 ...
 * ----------------
 *
 * In talking about the org.kframework.parser we have adopted the following naming conventions:
 *
...
public class Parser {
    ...
    /**
     * A StateCall represents the fact that the org.kframework.parser started parsing
    ...
    /**
     * A StateReturn represents the fact that the org.kframework.parser finished parsing
    ...
    /**
     * A NonTerminalCall represents the fact that the org.kframework.parser needs to try parsing
    ...
    /**
     * The state used internally by the org.kframework.parser.
     */
    ...
    /**
     * Main function to run the org.kframework.parser.
    ...
    /**
     * Contains the maximum position in the text which the org.kframework.parser managed to recognize.
     */
