...
/**
 * The classes used by the org.kframework.parser to represent the internal structure of a grammar.
 ...
 * <> - RuleState
 *
 * NOTE: compile() must be called before it is handed to the org.kframework.parser
 */
public class Grammar implements Serializable {
     ...
     * Must be called before being handed over to the org.kframework.parser, but after
    ...
    public abstract static class State implements Comparable<State>, Serializable {
        ...
        /**
         * Metadata used by the org.kframework.parser used to determine in what order to process StateReturns
         */
