...
object Constructors {
  ...
  def Production(klabel: String, sort: Sort, items: Seq[ProductionItem], att: attributes.Att) = definition.Production(sort, items, att.add(klabel), Option.empty, Source("generated"))
